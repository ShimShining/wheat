...
def add_guest(request):
    ...
    if eid == '' or phone == '' or realname == '':
        return JsonResponse({'status': 10021, 'message': '2019-11-03 parameter error', 'data': data})
...
def user_sign(request):
    ...
    if result:
        return JsonResponse({'status': 10027,'message': 'user has sign'})
    else:
